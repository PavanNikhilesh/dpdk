...
#define FLOW_KEY_TYPE_UDP_VXLAN  BIT(12)
#define FLOW_KEY_TYPE_UDP_GENEVE BIT(13)
#define FLOW_KEY_TYPE_UDP_GTPU   BIT(14)
#define FLOW_KEY_TYPE_INNR_IPV4     BIT(15)
#define FLOW_KEY_TYPE_INNR_IPV6     BIT(16)
#define FLOW_KEY_TYPE_INNR_TCP      BIT(17)
#define FLOW_KEY_TYPE_INNR_UDP      BIT(18)
#define FLOW_KEY_TYPE_INNR_SCTP     BIT(19)
#define FLOW_KEY_TYPE_INNR_ETH_DMAC BIT(20)
